...
namespace ProductService.Controllers
{
    ...
    {
        private readonly IProductBuisnesslayerService _productBLLService;
        private readonly IPublishEndpoint publishEndpoint;

        public ProductController(IProductBuisnesslayerService _productBLLService, IPublishEndpoint publishEndpoint)
        {

...
using RestSharp;
using ProductDetailDataLayer.Interfaces;



namespace ProductDetailBuisnessLayer
{
    public class ProductDetailBuisnessLayerService : IProductDetailBuisnessLayerService
    {
        private readonly IProductDetailRepository productDetailRepository;
        private readonly IPublishEndpoint publishEndpoint;

        public ProductDetailBuisnessLayerService(IProductDetailRepository productDetailRepository, IPublishEndpoint publishEndpoint)
        {

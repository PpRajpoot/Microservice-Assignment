...
using OrderBuisnessLayer.Interfaces;
using OrderDataLayer.Interfaces;
using Polly;
using RestSharp;


namespace OrderBuisnessLayer
{
    public class OrderBuisnessLayerService : IOrderBuisnessLayerService
    {
        private readonly IOrderRepository orderRepository;
        private readonly IPublishEndpoint publishEndpoint;
        public OrderBuisnessLayerService(IOrderRepository orderRepository, IPublishEndpoint publishEndpoint)
        {

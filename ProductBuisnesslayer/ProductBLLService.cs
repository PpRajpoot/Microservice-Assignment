...
using ProductDataLayer.Interfaces;
using RestSharp;
using System;
...
{
    public class ProductBuisnesslayerService : IProductBuisnesslayerService
    {
        private readonly IProductRepository productRepository;
        public ProductBuisnesslayerService(IProductRepository productRepository)
        {

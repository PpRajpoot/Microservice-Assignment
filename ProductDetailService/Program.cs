...
using MassTransit;
using ProductDetailBuisnessLayer;
using ProductDetailBuisnessLayer.Interfaces;
using ProductDetailDataLayer;
...
namespace ProductDetailService
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddScoped<IProductDetailBuisnessLayerService, ProductDetailBuisnessLayerService>();
